...
import jiidah from '../assets/jiidah.jpeg'
                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Dear Jiddah<span className="underline"></span>
                        </h4>
                        <h3 className="cover-title">
                            Happy Birthday!
                        </h3>
                        <p className="cover-subtitle">
                            A message just for you, my noor... 💌
                        </p>
                    </div>

                    {/* User Image remains the same */}
                    <div className="userImg">
                        <img src={jiidah} alt="Recipient's Photo" />
                    </div>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, Baby J ❤️</article>
                        ...
                        <p className="signature">
                            Your husband, In Shaa Allah, Abubakar
                        </p>
                    </div>
                </div>
            </div>
